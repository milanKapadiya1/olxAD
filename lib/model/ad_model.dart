...
List<Ad> getAhmedabadAds() {
  return [
    // --- VEHICLES ---
    Ad(
      image: 'https://images.unsplash.com/photo-1549399542-7e3f8b79c341?auto=format&fit=crop&w=500&q=60', // Hyundai Car
      title: 'Hyundai Creta SX',
      desc: '2019 Model, Diesel Automatic, Sunroof.\nWhite color, driven 45,000 km. Maintained at authorized service center.',
      price: 1150000,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1568772585407-9361f9bf3a87?auto=format&fit=crop&w=500&q=60', // Sporty Car
    ...
    Ad(
      image: 'https://images.unsplash.com/photo-1558981403-c5f9899a28bc?auto=format&fit=crop&w=500&q=60', // Bike
      title: 'KTM Duke 390',
      desc: '2022 Model, Orange color. Scratchless condition.\nValid insurance, dual channel ABS.',
      price: 240000,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1591635566278-10dca0ca76ee?auto=format&fit=crop&w=500&q=60', // Scooter
      title: 'Honda Activa 6G',
      desc: 'Matte Grey, 2023 purchase.\nDriven only 4,000 kms. Single owner lady driven.',
      price: 78000,
      location: 'Ahmedabad',
    ),
     Ad(
      image: 'https://images.unsplash.com/photo-1533473359331-0135ef1bcfb0?auto=format&fit=crop&w=500&q=60', // Car
      title: 'Toyota Innova Crysta',
      desc: '7 Seater, Captain seats. 2.4Z Diesel.\nFamily used car, excellent engine condition.',
      price: 1850000,
      location: 'Ahmedabad',
    ),
    ...
    // --- ELECTRONICS ---
    Ad(
      image: 'https://images.unsplash.com/photo-1616348436168-de43ad0db179?auto=format&fit=crop&w=500&q=60', // iPhone
      title: 'iPhone 14 Plus',
      desc: 'Blue color, 128GB. 10 months warranty left.\nBill box and cable available. Battery 100%.',
      price: 58000,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1593305841991-05c29736ce07?auto=format&fit=crop&w=500&q=60', // Gaming Mouse
      title: 'Logitech G502 Mouse',
      desc: 'Hero Gaming mouse, RGB light.\nHigh precision sensor, barely used for gaming.',
      price: 3500,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1588872657578-138a6c71097d?auto=format&fit=crop&w=500&q=60', // Laptop
      title: 'HP Pavilion Gaming',
      desc: 'Ryzen 5, GTX 1650 Graphics, 16GB RAM.\nGreat for editing and heavy work.',
      price: 42000,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1546435770-a3e426bf472b?auto=format&fit=crop&w=500&q=60', // Headphones
      title: 'Bose QC 45',
    ...
    Ad(
      image: 'https://images.unsplash.com/photo-1527443224154-c4a3942d3acf?auto=format&fit=crop&w=500&q=60', // Monitor
      title: 'BenQ 24 Inch Monitor',
      desc: '1080p Full HD, Eye care technology.\nStand included, HDMI cable free.',
      price: 8500,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1564466021-91487002cde3?auto=format&fit=crop&w=500&q=60', // Speaker
    ...
    // --- FURNITURE & HOME ---
    Ad(
      image: 'https://images.unsplash.com/photo-1505693314120-0d443867891c?auto=format&fit=crop&w=500&q=60', // Bed
      title: 'King Size Bed',
      desc: 'Solid Teak wood bed with storage.\nMattress not included. 6x6.5 feet.',
      price: 22000,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=500&q=60', // Chair
      title: 'Modern Accent Chair',
      desc: 'Yellow velvet fabric, gold legs.\nStatement piece for living room.',
      price: 6500,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=500&q=60', // Washing Machine
      title: 'LG Front Load 7kg',
      desc: 'Direct Drive motor, Steam wash.\n3 years old, working perfectly. Selling due to transfer.',
      price: 14000,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1556906781-9a412961d28c?auto=format&fit=crop&w=500&q=60', // Shoes
      title: 'Nike Jordan High',
      desc: 'Air Jordan 1 Chicago colorway.\nFirst copy premium quality. Size UK 9.',
      price: 2500,
      location: 'Ahmedabad',
    ),
     Ad(
      image: 'https://images.unsplash.com/photo-1581539250439-c96689b516dd?auto=format&fit=crop&w=500&q=60', // Glass Table
    ...
    // --- MISC ---
    Ad(
      image: 'https://images.unsplash.com/photo-1627384113743-6bd5a479fffd?auto=format&fit=crop&w=500&q=60', // Perfume
      title: 'Dior Sauvage Elixir',
      desc: 'Unwanted gift, 95% full bottle.\nOriginal packaging available. Strong projection.',
      price: 9000,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1571781926291-28b46a85e8b5?auto=format&fit=crop&w=500&q=60', // Dumbbells
      title: 'Adjustable Dumbbells',
      desc: 'Set of 2, adjustable weight 2kg to 10kg.\nRubber coated, good grip.',
      price: 3000,
      location: 'Ahmedabad',
    ),
    Ad(
      image: 'https://images.unsplash.com/photo-1503602642458-23211144584b?auto=format&fit=crop&w=500&q=60', // Camera Lens
    ...
    Ad(
      image: 'https://images.unsplash.com/photo-1543512214-318c77a799bf?auto=format&fit=crop&w=500&q=60', // Yoga Mat
      title: 'Premium Yoga Mat',
      desc: 'Extra thick 6mm mat, non-slip texture.\nPurple color, with carrying strap.',
      price: 800,
      location: 'Ahmedabad',
    ),
  ];
